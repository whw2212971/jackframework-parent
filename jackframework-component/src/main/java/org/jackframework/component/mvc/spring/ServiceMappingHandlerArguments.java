...
public abstract class ServiceMappingHandlerArguments {

    protected static final String BEAN_CLASS_PREFIX =
            ServiceMappingHandlerArguments.class.getSimpleName() + '$' + System.identityHashCode(ServiceMappingHandlerArguments.class) + "$";

    public abstract Object[] getArguments();

    @SuppressWarnings("unchecked")
    public static Class<? extends ServiceMappingHandlerArguments> createArgumentsBeanClass(ServiceMappingHandler handler) {
        ...
        String superClassName = getInternalName(ServiceMappingHandlerArguments.class);
        ...
        try {
            return (Class<? extends ServiceMappingHandlerArguments>) CaptainTools.loadByteCodes(className, cw.toByteArray());
        } catch (Throwable e) {
