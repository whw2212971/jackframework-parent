...
import org.jackframework.component.mvc.spring.ServiceErrorCodes;
import org.jackframework.component.mvc.spring.ServiceException;
import org.jackframework.component.mvc.spring.ServiceHolder;
import org.jackframework.component.mvc.spring.ServiceSession;
...
public class ServiceExceptionHandleFilter implements Filter {

    protected static final Logger LOGGER = LoggerFactory.getLogger(ServiceExceptionHandleFilter.class);
    ...
    protected String getRequestContent(HttpServletRequest request) {
        try {
            ...
            appendMessage(writer, "\nRequest Parameters: ", getRequestParameters(request));
            appendMessage(writer, "\nRequest Headers: ", getRequestHeaders(request));
            appendMessage(writer, "\nSession Attributes: ", getSessionAttributes(request));
    ...
    protected void appendMessage(CharsWriter writer, String prefix, String message) {
        if (message != null) {
            writer.append(prefix).write(message);
        }
    }
